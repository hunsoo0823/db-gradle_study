...
public class QueryTest {
     ...
     */
    public static List<String> titlesContainingText(String text, Session session) {
        Criteria criteria = session.createCriteria(Track.class);
     ...
     */
    public static List<Object[]> titlesContainingTextWithPlayTimes(String text, Session session) {
        Criteria criteria = session.createCriteria(Track.class);
        criteria.add(Restrictions.like("title", text, MatchMode.ANYWHERE)
                     .ignoreCase());
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            System.out.println(tracksWithArtistLike("Samuel %", session));
            System.out.println();
